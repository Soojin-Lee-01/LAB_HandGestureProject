...
extract_path = '../../NewData/forPointNet/TBO_ROInorm_4ch_aug0.01_sample64_tw1_p0.3/Train_'
model_save_subfix = extract_path.replace('../../NewData/forPointNet/','')
model_save_subfix = model_save_subfix.replace('/Train_','')
...
class OrthogonalRegularizer(keras.regularizers.Regularizer):
    ...
    def get_config(self):
        return {"num_features": self.num_features, "l2reg": float(self.l2reg)}
...
model.fit(train_dataset, epochs=500, validation_data=test_dataset, callbacks=[callback])
model.save(model_save_subfix+'.h5')
