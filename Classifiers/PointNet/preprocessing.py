...
seq_classify_functions = {
    'downToUp': classify_updown_feature,
    'leftToRight': classify_leftright_feature,
    'rightToLeft': classify_leftright_feature,
    'Spread': classify_spread_feature,
    'upToDown': classify_updown_feature
}

# =========================================================

# raw 데이터 위치
parent_dir = '../../NewData/TBO_5gesture/raw/'
# npz 파일 저장 위치
extract_path = '../../NewData/forPointNet/TBO'

# 클래스
classes = ['downToUp', 'leftToRight', 'rightToLeft', 'Spread', 'upToDown']
